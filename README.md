...
**Run Llama 3.2 and Gemma 2 locally** in your iOS and macOS apps in 3 lines of code. Open-source, offline, and private. Try it on [TestFlight](https://testflight.apple.com/join/Hr7xjkWX).
